...
def ycsb(workload,recordcount):
  ...
  cmd='cd /home/ubuntu/ycsb-0.1.4/ && bin/ycsb run voldemort -p bootstrap_urls=tcp://10.151.3.175:6666 -p recordcount='+recordcount+' -P workloads/'+ workload + '> voldemort.'+stime+'.res'
